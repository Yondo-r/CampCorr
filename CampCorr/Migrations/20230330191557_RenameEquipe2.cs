...
{
    public partial class RenameEquipe2 : Migration
    {
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Teams", x => x.EquipeId);
                    table.ForeignKey(
                        name: "FK_Teams_Campeonatos_CampeonatoId",
                        column: x => x.CampeonatoId,
                        principalTable: "Campeonatos",
                        principalColumn: "CampeonatoId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Teams_Temporadas_TemporadaId",
                        column: x => x.TemporadaId,
                        principalTable: "Temporadas",
                        principalColumn: "TemporadaId");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Teams_CampeonatoId",
                table: "Teams",
                column: "CampeonatoId");

            migrationBuilder.CreateIndex(
                name: "IX_Teams_TemporadaId",
                table: "Teams",
                column: "TemporadaId");
        }
    }
